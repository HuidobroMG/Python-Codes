...
Description:
    ...
    This code may read and show the frequencies present in a .wav file. It
    uses a fast fourier transformation of the Python library Scipy.
    At the end of the code it is also shown how to construct a Gaussian
    wavepacket of frequencies.
    
"""

#-----------------------------------------------------------------------------

# Import packages to read and analyze a sound
import numpy as np
